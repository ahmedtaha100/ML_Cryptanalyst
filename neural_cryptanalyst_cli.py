"""Minimal demo script for the Neural Cryptanalyst package."""
import numpy as np
from src.neural_cryptanalyst.attacks.profiled import ProfiledAttack
from src.neural_cryptanalyst.models import SideChannelCNN
from src.neural_cryptanalyst import (
    TracePreprocessor,
    FeatureSelector,
...
def align_traces(traces, reference_trace=None):
    """Align traces using correlation."""
    if traces.size == 0:
