"""
Complete power consumption model including all components from the paper.
"""
...
class CompletePowerConsumptionModel:
    """Full power consumption model implementing dynamic, static and short-circuit power."""
...
class PowerConsumptionModel(CompletePowerConsumptionModel):
    """Simplified power model for backward compatibility."""
